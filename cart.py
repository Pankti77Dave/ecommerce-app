...
@click.password_option('-password',required=True,confirmation_prompt=True,hide_input=False)
...
@cli.command()
@click.option('--username', prompt=True,required=True,hide_input=False)
